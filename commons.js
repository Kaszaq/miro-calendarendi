const CLIENT_ID = "3074457347056504522";
...
async function updateWidgets(widgets) {//todo: refactor this duplicate
    let widgetsCreated = [];
    let widgetCreationPromises = [];
    let i = 0;
    while (i < widgets.length) {
        widgetCreationPromises.push(miro.board.widgets.update(widgets.slice(i, i + WIDGETS_BATCH_SIZE)));
